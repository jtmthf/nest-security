...
export declare abstract class PasswordEncoder {
    /**
     ...
     * storage
     */
    abstract matches(rawPassword: string, encodedPassword: string): MaybePromise<boolean>;
    /**
...
//# sourceMappingURL=password-encoder.d.ts.map